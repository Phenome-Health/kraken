...
def main():
    ...
    with open(f"scripts/spoke_properties.json", 'w+') as output_file:
        json.dump({'nodes': node_counts_sorted,
                   'edges': edge_counts_sorted,
                   'nodes_examples': node_property_examples,
                   'edges_examples': edge_property_examples}, output_file, indent=2)
